...
public class HameleonPainted {

    public WebDriver driver;

    public HameleonPainted(WebDriver driver) {
    ...
    // Хамелеон в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='ХАМЕЛЕОН']//parent::a")
    private WebElement hameleonInCatalog;

    // Фасады Эмаль в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/hameleon-emal/']")
    private WebElement hameleonPainted;

    // Фасады Эмаль глянцевая
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyPaintedEmalGloss;
    ...
    public void addToBasket() {
        ...
        // Выбор фабрики Кедр
        hameleonInCatalog.click();

        // Выбор фасадов ПВХ фабрики Кедр
        hameleonPainted.click();

        // Выбор прямых фасадов
        fasadyPaintedEmalGloss.click();

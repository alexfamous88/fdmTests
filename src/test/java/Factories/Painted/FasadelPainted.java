...
public class FasadelPainted {

    public WebDriver driver;

    public FasadelPainted(WebDriver driver) {
    ...
    // Фасадель в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='ФАСАДЕЛЬ']//parent::a")
    private WebElement fasadelInCatalog;

    // Фасады эмаль в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/emal-fasadel/']")
    private WebElement fasadelPainted;

    // Фасады эмаль двусторонняя окраска матовая (Однотонное)
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyPaintedEmalDoubleMatte;
    ...
    public void addToBasket() {
        ...
        // Выбор фабрики Кедр
        fasadelInCatalog.click();

        // Выбор фасадов ПВХ фабрики Кедр
        fasadelPainted.click();

        // Выбор прямых фасадов
        fasadyPaintedEmalDoubleMatte.click();

...
public class FeChePvh {

    public WebDriver driver;

    public FeChePvh(WebDriver driver) {
    ...
    // ФЧ в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='Фасады Черноземья']//parent::a")
    private WebElement feCheInCatalog;

    // Фасады ПВХ в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/pvh-feche/']")
    private WebElement feChePvh;

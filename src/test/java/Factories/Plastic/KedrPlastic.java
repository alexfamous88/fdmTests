...
public class KedrPlastic {

    public WebDriver driver;

    public KedrPlastic(WebDriver driver) {
    ...
    @FindBy(xpath = "//*[@href='/select-facade/plastik/']")
    private WebElement kedrPlastic;

    // Фасады без окромления
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyBezOkromleniya;

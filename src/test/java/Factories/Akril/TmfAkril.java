...
public class TmfAkril {

    public WebDriver driver;

    public TmfAkril(WebDriver driver) {
    ...
    @FindBy(xpath = "//*[@href='/select-facade/akril-tmf/']")
    private WebElement tmfAkril;

    // Фасады акриловые в кромке в цвет
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyAkrilWithEdge;

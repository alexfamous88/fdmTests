...
public class StandartPvh {

    public WebDriver driver;

    public StandartPvh(WebDriver driver) {
    ...
    // Стандарт в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='СТАНДАРТ']//parent::a")
    private WebElement standartInCatalog;

    // Фасады ПВХ в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/pvh-standart/']")
    private WebElement standartPvh;

...
public class DemfaPainted {

    public WebDriver driver;

    public DemfaPainted(WebDriver driver) {
    ...
    // Демфа в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='DEMFA']//parent::a")
    private WebElement demfaInCatalog;

    // Фасады эмаль в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/emal-demfa/']")
    private WebElement demfaPainted;

    // Фасады Эмаль полуматовая
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyPaintedEmalHalfMatte;

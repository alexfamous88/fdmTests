...
public class LotosAgt {

    public WebDriver driver;

    public LotosAgt(WebDriver driver) {
    ...
    // Фасады из панелей AGT
    @FindBy(xpath = "(//*[@class='factory-list open']//a)[5]")
    private WebElement fasadyAgt;

    // Стандарт в Каталоге
    @FindBy(xpath = "//*[@class='factory-data']//*[@alt='ЛОТОС-ЮГ']//parent::a")
    private WebElement lotosInCatalog;

    // Фасады из панелей AGT в Каталоге
    @FindBy(xpath = "//*[@href='/select-facade/fasady-panel-agt-lotos-ug/']")
    private WebElement lotosAgt;

    // Фасады AGT кромка в цвет ABS 1мм
    @FindBy(xpath = "(//*[@class='row']//a)[1]")
    private WebElement fasadyAgtAbs;
